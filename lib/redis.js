...
// Simple page-view counter, not unique-visitor deduplication - every page
// load increments today's count, no IP/cookie tracking involved. Stored as
// one counter per calendar day (UTC), so "today" / "this week" / "this
// month" / "all-time" can all be derived by summing the right date keys,
// without needing a separate aggregation job or a growing list of raw events.
